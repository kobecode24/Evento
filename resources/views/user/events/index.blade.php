                    ...
                    @foreach ($events as $event)
                        <div class="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 px-4 mb-8">
                            <div class="rounded overflow-hidden shadow-lg flex flex-col">
                                <div class="relative">
                                    <a href="--}}{{--{{ route('events.show', $event->id) }}--}}{{--">
                                        <img class="w-full"
                                             src="{{ $event->image_url }}" --}}{{-- Assume you have an image URL attribute --}}{{--
                                             alt="{{ $event->title }}">
                                        <div
                                    ...
                                    <a href="#!">
                                        <div
                                            ...
                                            {{ $event->category_name }} --}}{{-- Assume you have a category name --}}{{--
                                        </div>
                                    </a>
                                </div>
                                <div class="px-6 py-4 mb-auto">
                                    <a href="--}}{{--{{ route('events.show', $event->id) }}--}}{{--"
                                       class="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">{{ $event->title }}</a>
                            ...
                            <span class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                                ...
                                <span class="ml-1">{{ $event->created_at->diffForHumans() }}</span>
                            </span>

                                    <span class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
                                --}}{{-- SVG icons omitted for brevity --}}{{--
                                <span class="ml-1">{{ $event->comments_count }} Comments</span>
                            </span>
                                </div>
                            </div>
                        </div>
